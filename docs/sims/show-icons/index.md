...
[View IT Icons Gallery Fullscreen](main.html){ .md-button .md-button--primary }
...
1. **Browse by category** - Scroll through organized sections to find the right icon type
2. **Copy filenames** - Click any icon to copy its filename for use in documentation
3. **Visual reference** - Use this gallery to see all available icons at a glance
4. **Icon selection** - Choose appropriate icons for diagrams, documentation, or presentations
...
- Relative paths to icon files (`../../it-icons/`)
- Error handling for missing icons with placeholder display
